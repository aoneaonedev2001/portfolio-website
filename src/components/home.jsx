...
const Home = () => {
  ...
  return (
    <section name="Home" className="h-[70vh] sm:h-full sm:mt-[50px] mt-[140px]">
      <div className='flex flex-row sm:justify-center items-center sm:flex-col-reverse h-[500px] sm:h-[630px]'>
        <div className='w-[60%] sm:w-[100%] h-full flex flex-col justify-center sm:items-center gap-y-[25px]'>
          <motion.h1
            variants={Container(0)}
            initial={'hidden'}
            animate={'visible'}
            className='font-medium sm:mt-[19px] text-7xl sm:text-[47px] text-[#1F2937]'>
            Aone Obomo
          </motion.h1>
          <motion.h3
          ...
          <motion.div
            ...
            <p>I am a passionate and skilled web developer specializing in creating</p>
            <p>efficient and user-friendly web applications. With over 2 years of</p>
            <p>experience, I have honed my expertise in various technologies such</p>
        ...
        <motion.div
          ...
          className='w-[40%] sm:w-[100%] h-full flex justify-center items-center'>
          <img src={Heroimg} alt="hero Aone" className="sm:w-[276px] sm:h-[339px]" />
        </motion.div>
      </div>
    </section>
  )
